...
public class SymulatorParkometru extends javax.swing.JFrame {
    ...
    private void plusCzasButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_plusCzasButtonActionPerformed
        ...
        double doZaplaty = czasParkowania * 0.2;
        doZaplaty -= zaplacono;
        doZaplatyField.setText(Double.toString(doZaplaty));
        pozostaloField.setText(Double.toString(doZaplaty));
    ...
    private void wrzucButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_wrzucButtonActionPerformed
        ...
        if (pozostalo - kwota >= 0) {
            zaplacono += kwota;
            pozostaloField.setText(Double.toString(pozostalo - kwota));
        } else if (pozostalo - kwota < 0 && pozostalo > 0) {
            double reszta = Double.valueOf(resztaField.getText());
            zaplacono += Double.valueOf(pozostaloField.getText()) + reszta;
            pozostaloField.setText("0");
            reszta += Math.abs(pozostalo - kwota);
